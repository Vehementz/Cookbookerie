...
ticker = input("Enter the ticker symbol  exemple MSFT: ")
...
### No dynamic file, just finded
# url = "https://query1.finance.yahoo.com/v7/finance/download/%5ERUT?period1=1649430022&period2=1680966022&interval=1d&events=history&includeAdjustedClose=true"
